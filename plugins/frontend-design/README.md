...
Original plugin authored by Anthropic:
...
This is a repackaging of that plugin for the Athena workflow marketplace (cross-runtime layout: Claude Code + Codex). Skill content is unchanged from upstream; only manifests and overlays were added. All design credit and IP belong to the original authors at Anthropic.
